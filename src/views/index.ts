...
export const views: Record<RouterPage.LastDegreeRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  combinedorder_detail: () => import('./combinedorder/detail/index.vue'),
  combinedorder_orderforgoods: () => import('./combinedorder/orderforgoods/index.vue'),
  ...
  returnshipment_returnshipmentorder_detail: () => import('./returnshipment/returnshipmentorder/detail/index.vue'),
  returnshipment_returnshipmentorder: () => import('./returnshipment/returnshipmentorder/index.vue'),
